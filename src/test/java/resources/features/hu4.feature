Feature: Suscribirse en la aplicación
  ...
  Scenario: Usuario que realiza una suscripción por primera vez
  ...
  Scenario: Usuario que contrata o brinda el servicio de alquiler quiere ver las suscripciones disponibles.
    Given El usuario se encuentra en la vista Home
